    ...
    <div className={styles.PageLayout}>
      {invoice?.creator?.includes(
        ...
        <div className={styles.buttons}>
          ...
          >
            {unicodeToChar(t("invoice.send_to_customer"))}
          </ProgressButton>

          <ProgressButton onClick={createAndDownloadPdf} state={downloadStatus}>
            {unicodeToChar(t("invoice.download_pdf"))}
          </ProgressButton>
          ...
          >
            ...
            {unicodeToChar(t("invoice.edit_invoice"))}
          </button>
          ...
          >
            ...
            {unicodeToChar(t("invoice.record_payment"))}
          </button>
        </div>
      )}
