...
import { toCommas, unicodeToChar } from "../../utils/utils";
    ...
    return (
      ...
      >
        ...
        <p style={{ padding: "40px", color: "gray" }}>
          {unicodeToChar(t("dashboard.nothing_to_show"))}
        </p>
      </div>
    );
  }
        ...
        <ul className={styles.autoGrid}>
          ...
          >
            <div>
              ...
              <h2 style={{ color: "white" }}>
                {unicodeToChar(t("dashboard.payment_recieved"))}
              </h2>
            </div>
            <div>
              <Check />
          ...
          <li className={styles.listItem}>
            <div>
              ...
              <h2>{unicodeToChar(t("dashboard.pending_amount"))}</h2>
            </div>
            <div>
              <Pie />
            </div>
          ...
          <li className={styles.listItem}>
            <div>
              ...
              <h2>{unicodeToChar(t("dashboard.total_amount"))}</h2>
            </div>
            <div>
              <Bag />
            </div>
          ...
          <li className={styles.listItem}>
            <div>
              <p>{invoices.length}</p>
              <h2>{unicodeToChar(t("dashboard.total_invoices"))}</h2>
            </div>
            <div>
              <Card />
            </div>
          ...
          >
            <div>
              <p>{paid.length}</p>
              <h2 style={{ color: "white" }}>
                {unicodeToChar(t("dashboard.paid_invoices"))}
              </h2>
            </div>
            <div>
              <Check />
          ...
          <li className={styles.listItem}>
            <div>
              <p>{partial.length}</p>
              <h2>{unicodeToChar(t("dashboard.partially_paid_invoices"))}</h2>
            </div>
            <div>
              <Pie />
            </div>
          ...
          <li className={styles.listItem}>
            <div>
              ...
              <h2>{unicodeToChar(t("dashboard.unpaid_invoices"))}</h2>
            </div>
            <div>
              <Frown />
            </div>
          ...
          <li className={styles.listItem}>
            <div>
              <p>{overDue.length}</p>
              <h2>{unicodeToChar(t("dashboard.overdue"))}</h2>
            </div>
            <div>
              <Clock />
            </div>
      ...
      <section>
        <h1 style={{ textAlign: "center", padding: "30px" }}>
          {paymentHistory.length
            ? unicodeToChar(t("dashboard.recent_payments"))
            : unicodeToChar(t("dashboard.no_payments"))}
        </h1>
        <div>
