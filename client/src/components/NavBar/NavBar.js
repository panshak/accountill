        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <Link to="/dashboard" className="nav-link">
              ...
              <span className="link-text">
                {unicodeToChar(t("navbar.dashboard"))}
              </span>
            </Link>
          </li>
          ...
          <li className="nav-item">
            <a href="/invoices" className="nav-link">
              ...
              <span className="link-text">
                {unicodeToChar(t("navbar.invoices"))}
              </span>
            </a>
          </li>
          <li className="nav-item">
            <a href="/customers" className="nav-link">
              ...
              <span className="link-text">
                {unicodeToChar(t("navbar.customers"))}
              </span>
            </a>
          </li>
          {/* <li className="nav-item">
        ...
        <span className="link-text">Shuttle</span>
          ...
          <li className="nav-item" id="themeButton">
            <a href="/settings" className="nav-link">
              ...
              <span className="link-text">
                {unicodeToChar(t("navbar.settings"))}
              </span>
            </a>
          </li>
        </ul>
